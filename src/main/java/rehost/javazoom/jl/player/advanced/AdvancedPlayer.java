...
package rehost.javazoom.jl.player.advanced;

import java.io.InputStream;

import rehost.javazoom.jl.decoder.Bitstream;
import rehost.javazoom.jl.decoder.BitstreamException;
import rehost.javazoom.jl.decoder.Decoder;
import rehost.javazoom.jl.decoder.Header;
import rehost.javazoom.jl.decoder.JavaLayerException;
import rehost.javazoom.jl.decoder.SampleBuffer;
import rehost.javazoom.jl.player.AudioDevice;
import rehost.javazoom.jl.player.FactoryRegistry;

/**
 * a hybrid of rehost.javazoom.jl.player.Player tweeked to include <code>play(startFrame, endFrame)</code>
